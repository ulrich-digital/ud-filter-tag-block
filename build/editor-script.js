...
module.exports = /*#__PURE__*/JSON.parse('{"apiVersion":2,"name":"ud/filter-tag-block","title":"Filter-Tag","category":"text","icon":"filter","description":"Ein klickbares Filter-Element mit Label und zugewiesenem Tag. Wird z.B. mit Isotope.js verwendet.","textdomain":"ud-filter-tag-block","editorStyle":"file:./build/editor-style.css","style":"file:./build/frontend-style.css","editorScript":"file:./build/editor-script.js","script":"file:./build/frontend-script.js","supports":{"html":false},"attributes":{"filters":{"type":"array","default":[]},"applyToAccordion":{"type":"boolean","default":false},"filterableTargets":{"type":"array","default":[]},"enabledTargets":{"type":"array","default":[]}}}');
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.FlexItem, {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
          ...
          style: {
            padding: 0,
            height: "20px"
          } // optional, falls zu viel Abstand
          ,
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("span", {
            style: {
              width: "20px",
            ...
            children: _wordpress_icons__WEBPACK_IMPORTED_MODULE_7__["default"]
          })
        })
      })]
    })
...
function Edit({
  ...
  const [availableTags, setAvailableTags] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  const [newLabel, setNewLabel] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  const [newTag, setNewTag] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  ...
  const [editTag, setEditTag] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)("");
  const editButtonRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useRef)();
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({
    className: "filter-group-block"
  });
  ...
  const loadTags = () => {
    ...
    }).then(res => res.json()).then(tags => Array.isArray(tags) && setAvailableTags(tags)).catch(() => setAvailableTags([]));
  };
  function addFilter() {
  ...
  function handleDragEnd(event) {
    ...
    if (oldIndex !== -1 && newIndex !== -1) {
      setAttributes({
        filters: (0,_dnd_kit_sortable__WEBPACK_IMPORTED_MODULE_4__.arrayMove)(filters, oldIndex, newIndex)
      });
    }
  }
  const [hasAccordion, setHasAccordion] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const observer = new MutationObserver(() => {
      const found = document.querySelector(".wp-block-ud-accordion-block");
    ...
    // Initialprüfung
    setHasAccordion(!!document.querySelector(".wp-block-ud-accordion-block"));
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_dnd_kit_core__WEBPACK_IMPORTED_MODULE_3__.DndContext, {
          sensors: sensors,
          collisionDetection: _dnd_kit_core__WEBPACK_IMPORTED_MODULE_3__.closestCenter,
          onDragEnd: handleDragEnd,
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_dnd_kit_sortable__WEBPACK_IMPORTED_MODULE_4__.SortableContext, {
            items: filters.map(f => f.id),
            children: filters.map(filter => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(SortableFilterItem, {
              id: filter.id,
              filter: filter,
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
        ...
        }), isOpen && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Popover, {
          ...
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("h3", {
            ...
            children: "Filter hinzuf\xFCgen"
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
            className: "input_fields",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.__experimentalInputControl, {
              label: "Anzeigetext",
              value: newLabel,
    ...
    }), editingId && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Popover, {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("h3", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Button, {
          ...
          onClick: () => {
            const updated = filters.map(f => f.id === editingId ? {
              ...f,
              label: editLabel,
              tag: editTag
            } : f);
...
function slugify(text) {
  return text.toString().normalize("NFKD").replace(/[\u0300-\u036f]/g, "").replace(/ä/g, "ae").replace(/ö/g, "oe").replace(/ü/g, "ue").replace(/ß/g, "ss").toLowerCase().trim().replace(/[^a-z0-9]+/g, "-").replace(/^-+|-+$/g, "");
}
function save({
  attributes
}) {
